...
def savings(gross_pay, tax_rate, expenses):
    ...
    remaining_money = int(after_tax_pay - expenses)
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    total_consumed_materials = num_jobs * job_consumption
    materials_left = total_material - total_consumed_materials
    result = str(materials_left) + (material_units)
    return result
...
def interest(principal, rate, periods):
    ...
    simple_interest = principal * periodic_rate
